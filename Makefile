...
tecnicofs-nosync: lib/bst.o lib/hash.o lib/inodes.o fs.o sync.o main.o

### MUTEX ###
lib/bst-mutex.o: CFLAGS+=-DMUTEX
lib/bst-mutex.o: lib/bst.c lib/bst.h

lib/inodes-mutex.o: CFLAGS+=-DMUTEX
lib/inodes-mutex.o: lib/inodes.c lib/inodes.h

lib/hash-mutex.o: CFLAGS+=-DMUTEX
lib/hash-mutex.o: lib/hash.c lib/hash.h

fs-mutex.o: CFLAGS+=-DMUTEX
fs-mutex.o: fs.c fs.h lib/bst.h lib/hash.h lib/inodes.h
...
tecnicofs-mutex: lib/bst-mutex.o lib/hash-mutex.o lib/inodes-mutex.o fs-mutex.o sync-mutex.o main-mutex.o
...
fs-rwlock.o: fs.c fs.h lib/bst.h lib/inodes.h
...
tecnicofs-rwlock: lib/bst-rwlock.o lib/hash-rwlock.o lib/inodes-rwlock.o fs-rwlock.o sync-rwlock.o main-rwlock.o
